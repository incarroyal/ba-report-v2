...
// 표준 담보 카테고리 — 프런트(index_22.html)의 GROUPS와 1:1 동기화 (2026.07 동기화 완료)
const CATEGORIES = [
  "일반사망","질병사망","상해사망",
  "질병입원의료비","질병통원의료비","상해입원의료비","상해통원의료비",
  "일반암진단비","유사암진단비","암치료비",
  "뇌혈관질환진단비","뇌졸중진단비","뇌출혈진단비","뇌혈관치료비",
  "허혈성심장질환진단비","급성심근경색진단비","심장질환치료비",
  "질병수술비","상해수술비","종수술비(1~5종)","특정질병수술비",
  "질병입원일당","상해입원일당","질병간병인일당","상해간병인일당",
  "레켐비치료비","재가급여","복지용구","데이케어센터",
...
const COV_ITEM = {
  ...
  properties: {
    ...
    catIdx: { type: "integer", description: "표준 카테고리 번호(프롬프트의 번호표 참조). 해당 없으면 36(기타)" },
...
- 사망: 종신·정기보험 주계약 사망보험금 → 일반사망 / '질병사망' → 질병사망 / 상해·재해사망 → 상해사망
- '유사암'에는 제자리암·경계성종양·갑상선암·기타피부암·소액암이 포함됨 → 유사암진단비
- 원발암 진단비(유사암제외 표기 포함) → 일반암진단비
- 그 외 암 관련 담보는 모두 → 암치료비: 전이암·재진단암 진단비, 암수술비, 표적항암약물·항암방사선약물·세기조절방사선·다빈치로봇, 암직접치료입원일당·암통원 등
- '뇌혈관질환'은 뇌졸중·뇌출혈을 포괄하는 상위 개념. '뇌졸중'은 뇌졸중진단비, '뇌출혈'은 뇌출혈진단비로 각각 구분
- 뇌혈관 관련 수술비·치료비·입원일당 → 뇌혈관치료비
- '허혈성심장질환'은 급성심근경색을 포괄. '급성심근경색'만 명시되면 급성심근경색진단비
- 심장 관련 수술비·치료비 → 심장질환치료비
- 1~5종 / 1~7종 수술비, N종수술비 → 종수술비(1~5종)
- 특정질병·N대질병 수술비 → 특정질병수술비 (수술비 분류를 뇌·심장보다 우선 적용: '82대질병수술비(뇌혈관질환)'은 특정질병수술비)
- 입원일당: 질병입원일당 / 상해(재해·교통)입원일당 구분
- 간병인 사용·지원 일당 → 질병간병인일당 / 상해 명시 시 상해간병인일당
- 요양·치매: 레켐비(레카네맙) 치료비 → 레켐비치료비 / 장기요양 재가급여(방문요양·방문목욕 등) → 재가급여 / 복지용구 지원 → 복지용구 / 데이케어센터·주야간보호 → 데이케어센터. 치매진단비·장기요양자금 등 그 외 치매·요양 담보는 기타
- 운전자 관련: 교통사고처리지원금(형사합의금 포함), 변호사선임비용, 벌금(대인/대물 구분), 자동차사고부상위로금(부상등급별 위로금)
- 일상생활중배상책임·가족일상생활배상책임 → 일상생활배상책임
- 화재손해·화재복구비용 등 화재 관련 → 화재보험
- 후유장해·골절·깁스·응급실내원·치아·여행자·운전자휴업 등 위에 없는 담보는 '기타'
[금액 규칙]
